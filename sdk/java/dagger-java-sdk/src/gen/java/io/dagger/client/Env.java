...
public class Env implements IDAble<EnvID> {
    ...
    /**
     * <p>Create or update a binding of type JavaSdk in the environment</p>
     * @param name The name of the binding
     * @param value The JavaSdk value to assign to the binding
     * @param description The purpose of the input
     */
    public Env withJavaSdkInput(String name, JavaSdk value, String description) {
        Arguments.Builder builder = Arguments.newBuilder();
        builder.add("name", name);
        builder.add("value", value);
        builder.add("description", description);
        Arguments fieldArgs = builder.build();
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("withJavaSdkInput", fieldArgs);
        return new Env(nextQueryBuilder);
    }

    /**
     * <p>Declare a desired JavaSdk output to be assigned in the environment</p>
     * @param name The name of the binding
     * @param description A description of the desired value of the binding
     */
    public Env withJavaSdkOutput(String name, String description) {
        Arguments.Builder builder = Arguments.newBuilder();
        builder.add("name", name);
        builder.add("description", description);
        Arguments fieldArgs = builder.build();
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("withJavaSdkOutput", fieldArgs);
        return new Env(nextQueryBuilder);
    }
