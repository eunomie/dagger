...
public class Container implements IDAble<ContainerID> {
    ...
    /**
     * <p>Returns a File representing the container serialized to a tarball.</p>
    ...
    /**
     * <p>The exit code of the last executed command.<br/><br/>Returns an error if no command was set.</p>
     */
    ...
    /**
     * <p>Publishes this container as a new image to the specified address.<br/><br/>Publish returns a fully qualified ref.<br/><br/>It can also publish platform variants.</p>
    ...
    /**
     * <p>The error stream of the last executed command.<br/><br/>Returns an error if no command was set.</p>
     */
    ...
    /**
     * <p>The output stream of the last executed command.<br/><br/>Returns an error if no command was set.</p>
     */
     ...
     * @param args Command to run instead of the container's default command (e.g., ["go", "run", "main.go"]).<br/><br/>If empty, the container's default command is used.
    ...
    /**
     * <p>Expose a network port.<br/><br/>Exposed ports serve two purposes:<br/><br/>- For health checks and introspection, when running services<br/><br/>- For setting the EXPOSE OCI field when publishing the container</p>
     ...
     * @param address Registry's address to bind the authentication to.<br/><br/>Formatted as [host]/[user]/[repo]:[tag] (e.g. docker.io/dagger/dagger:main).
    ...
    /**
     * <p>Retrieves the container with the given directory mounted to /.</p>
    ...
    /**
     * <p>Retrieves this container with unset default arguments for future commands.</p>
     */
    ...
    /**
     * <p>Retrieves this container with the directory at the given path removed.</p>
    ...
    /**
     * <p>Retrieves this container with an unset command entrypoint.</p>
    ...
    /**
     * <p>Retrieves this container with the files at the given paths removed.</p>
    ...
    /**
     * <p>Retrieves this container with an unset working directory.<br/><br/>Should default to "/".</p>
     */
    ...
    public static class AsServiceArguments {
        ...
        /**
         * Provides Dagger access to the executed command.<br/><br/>Do not use this option unless you trust the command being executed; the command being executed WILL BE GRANTED FULL ACCESS TO YOUR HOST FILESYSTEM.
         */
    ...
    public static class PublishArguments {
        ...
        /**
         * Use the specified media types for the published image's layers.<br/><br/>Defaults to OCI, which is largely compatible with most recent registries, but Docker may be needed for older registries without OCI support.
         */
