...
public class Client {
    ...
    /**
     * <p>Creates a scratch container.<br/><br/>Optional platform argument initializes new containers to execute and publish as that platform. Platform defaults to that of the builder's host.</p>
    ...
    /**
     * <p></p>
     * @param optArgs javaSdk optional arguments
     */
    public JavaSdk javaSdk(JavaSdkArguments optArgs) {
        Arguments.Builder builder = Arguments.newBuilder();
        Arguments fieldArgs = builder.build();
        fieldArgs = fieldArgs.merge(optArgs.toArguments());
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("javaSdk", fieldArgs);
        return new JavaSdk(nextQueryBuilder);
    }
    ...
    /**
     * <p>Load a JavaSdk from its ID.</p>
     * @param id 
     */
    public JavaSdk loadJavaSdkFromID(JavaSdkID id) {
        Arguments.Builder builder = Arguments.newBuilder();
        builder.add("id", id);
        Arguments fieldArgs = builder.build();
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("loadJavaSdkFromID", fieldArgs);
        return new JavaSdk(nextQueryBuilder);
    }
    ...
    /**
     * <p>Load a Secret from its Name.</p>
     * @param name 
     * @param optArgs loadSecretFromName optional arguments
     */
    public Secret loadSecretFromName(String name, LoadSecretFromNameArguments optArgs) {
        Arguments.Builder builder = Arguments.newBuilder();
        builder.add("name", name);
        Arguments fieldArgs = builder.build();
        fieldArgs = fieldArgs.merge(optArgs.toArguments());
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("loadSecretFromName", fieldArgs);
        return new Secret(nextQueryBuilder);
    }
     ...
     * @param name 
     */
    public Secret loadSecretFromName(String name) {
        Arguments.Builder builder = Arguments.newBuilder();
        builder.add("name", name);
        Arguments fieldArgs = builder.build();
        QueryBuilder nextQueryBuilder = this.queryBuilder.chain("loadSecretFromName", fieldArgs);
    ...
    /**
     * Optional arguments for {@link Client#javaSdk}
     *
     */
    public static class JavaSdkArguments {
        ...
        /**
         * <br/>Directory with the Java SDK source code.<br/>dagger-java-samples is not necessary to build, but as it's referenced in the root pom.xml maven<br/>will check if it's there. So we keep the pom.xml to fake it.<br/>
         */
        public JavaSdkArguments withSdkSourceDir(Directory sdkSourceDir) {
            this.sdkSourceDir = sdkSourceDir;
            return this;
        }
        ...
        Arguments toArguments() {
            ...
            if (sdkSourceDir != null) {
                builder.add("sdkSourceDir", this.sdkSourceDir);
            }
    ...
    /**
     * Optional arguments for {@link Client#loadSecretFromName}
     *
     */
    public static class LoadSecretFromNameArguments {
         ...
         *
         */
        public LoadSecretFromNameArguments withAccessor(String accessor) {
        ...
        Arguments toArguments() {
            Arguments.Builder builder = Arguments.newBuilder();
            if (accessor != null) {
                builder.add("accessor", this.accessor);
            }
