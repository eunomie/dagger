...
class Env extends Client\AbstractObject implements Client\IdAble
{
     ...
     */
    public function withIntrospectionDirectiveArgInput(
        string $name,
        IntrospectionDirectiveArgId|IntrospectionDirectiveArg $value,
        string $description,
    ): Env {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionDirectiveArgInput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('value', $value);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
     ...
     */
    public function withIntrospectionDirectiveArgOutput(string $name, string $description): Env
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionDirectiveArgOutput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
     ...
     */
    public function withIntrospectionDirectiveInput(
        string $name,
        IntrospectionDirectiveId|IntrospectionDirective $value,
        string $description,
    ): Env {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionDirectiveInput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('value', $value);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
     ...
     */
    public function withIntrospectionDirectiveOutput(string $name, string $description): Env
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionDirectiveOutput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
     ...
     */
    public function withIntrospectionEnumValueInput(
        string $name,
        IntrospectionEnumValueId|IntrospectionEnumValue $value,
        string $description,
    ): Env {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionEnumValueInput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('value', $value);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
     ...
     */
    public function withIntrospectionEnumValueOutput(string $name, string $description): Env
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionEnumValueOutput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
     ...
     */
    public function withIntrospectionFieldInput(
        string $name,
        IntrospectionFieldId|IntrospectionField $value,
        string $description,
    ): Env {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionFieldInput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('value', $value);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
     ...
     */
    public function withIntrospectionFieldOutput(string $name, string $description): Env
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionFieldOutput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
     ...
     */
    public function withIntrospectionInputValueInput(
        string $name,
        IntrospectionInputValueId|IntrospectionInputValue $value,
        string $description,
    ): Env {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionInputValueInput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('value', $value);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
     ...
     */
    public function withIntrospectionInputValueOutput(string $name, string $description): Env
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionInputValueOutput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
     ...
     */
    public function withIntrospectionTypeInput(
        string $name,
        IntrospectionTypeId|IntrospectionType $value,
        string $description,
    ): Env {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionTypeInput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('value', $value);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
     ...
     */
    public function withIntrospectionTypeOutput(string $name, string $description): Env
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionTypeOutput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
     ...
     */
    public function withIntrospectionTypeRefInput(
        string $name,
        IntrospectionTypeRefId|IntrospectionTypeRef $value,
        string $description,
    ): Env {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionTypeRefInput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('value', $value);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
     ...
     */
    public function withIntrospectionTypeRefOutput(string $name, string $description): Env
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withIntrospectionTypeRefOutput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
     ...
     */
    public function withSchemaInput(string $name, SchemaId|Schema $value, string $description): Env
    {
     ...
     */
    public function withWorkspaceMigrationStepInput(
        string $name,
        WorkspaceMigrationStepId|WorkspaceMigrationStep $value,
        string $description,
    ): Env {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withWorkspaceMigrationStepInput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('value', $value);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
     ...
     */
    public function withWorkspaceMigrationStepOutput(string $name, string $description): Env
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withWorkspaceMigrationStepOutput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
     ...
     */
    public function withWorkspaceModuleSettingInput(
        string $name,
        WorkspaceModuleSettingId|WorkspaceModuleSetting $value,
        string $description,
    ): Env {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withWorkspaceModuleSettingInput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('value', $value);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
     ...
     */
    public function withWorkspaceModuleSettingOutput(string $name, string $description): Env
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('withWorkspaceModuleSettingOutput');
        $innerQueryBuilder->setArgument('name', $name);
        $innerQueryBuilder->setArgument('description', $description);
        return new \Dagger\Env($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
