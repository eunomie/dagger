...
class IntrospectionDirectiveArgID(Scalar):
    """The `IntrospectionDirectiveArgID` scalar type represents an
    identifier for an object of type IntrospectionDirectiveArg."""


class IntrospectionDirectiveID(Scalar):
    """The `IntrospectionDirectiveID` scalar type represents an identifier
    for an object of type IntrospectionDirective."""


class IntrospectionEnumValueID(Scalar):
    """The `IntrospectionEnumValueID` scalar type represents an identifier
    for an object of type IntrospectionEnumValue."""


class IntrospectionFieldID(Scalar):
    """The `IntrospectionFieldID` scalar type represents an identifier for
    an object of type IntrospectionField."""


class IntrospectionInputValueID(Scalar):
    """The `IntrospectionInputValueID` scalar type represents an
    identifier for an object of type IntrospectionInputValue."""


class IntrospectionTypeID(Scalar):
    """The `IntrospectionTypeID` scalar type represents an identifier for
    an object of type IntrospectionType."""


class IntrospectionTypeRefID(Scalar):
    """The `IntrospectionTypeRefID` scalar type represents an identifier
    for an object of type IntrospectionTypeRef."""
...
class SchemaID(Scalar):
    """The `SchemaID` scalar type represents an identifier for an object
    of type Schema."""
...
class WorkspaceModuleSettingID(Scalar):
    """The `WorkspaceModuleSettingID` scalar type represents an identifier
    for an object of type WorkspaceModuleSetting."""
...
class Binding(Type):
    ...
    def as_introspection_directive(self) -> "IntrospectionDirective":
        """Retrieve the binding value, as type IntrospectionDirective"""
        _args: list[Arg] = []
        _ctx = self._select("asIntrospectionDirective", _args)
        return IntrospectionDirective(_ctx)

    def as_introspection_directive_arg(self) -> "IntrospectionDirectiveArg":
        """Retrieve the binding value, as type IntrospectionDirectiveArg"""
        _args: list[Arg] = []
        _ctx = self._select("asIntrospectionDirectiveArg", _args)
        return IntrospectionDirectiveArg(_ctx)

    def as_introspection_enum_value(self) -> "IntrospectionEnumValue":
        """Retrieve the binding value, as type IntrospectionEnumValue"""
        _args: list[Arg] = []
        _ctx = self._select("asIntrospectionEnumValue", _args)
        return IntrospectionEnumValue(_ctx)

    def as_introspection_field(self) -> "IntrospectionField":
        """Retrieve the binding value, as type IntrospectionField"""
        _args: list[Arg] = []
        _ctx = self._select("asIntrospectionField", _args)
        return IntrospectionField(_ctx)

    def as_introspection_input_value(self) -> "IntrospectionInputValue":
        """Retrieve the binding value, as type IntrospectionInputValue"""
        _args: list[Arg] = []
        _ctx = self._select("asIntrospectionInputValue", _args)
        return IntrospectionInputValue(_ctx)

    def as_introspection_type(self) -> "IntrospectionType":
        """Retrieve the binding value, as type IntrospectionType"""
        _args: list[Arg] = []
        _ctx = self._select("asIntrospectionType", _args)
        return IntrospectionType(_ctx)

    def as_introspection_type_ref(self) -> "IntrospectionTypeRef":
        """Retrieve the binding value, as type IntrospectionTypeRef"""
        _args: list[Arg] = []
        _ctx = self._select("asIntrospectionTypeRef", _args)
        return IntrospectionTypeRef(_ctx)
...
class Env(Type):
    ...
    def with_introspection_directive_arg_input(
        self,
        name: str,
        value: "IntrospectionDirectiveArg",
        description: str,
    ) -> Self:
        """Create or update a binding of type IntrospectionDirectiveArg in the
        environment
        ...
        name:
            The name of the binding
        value:
            The IntrospectionDirectiveArg value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withIntrospectionDirectiveArgInput", _args)
        return Env(_ctx)

    def with_introspection_directive_arg_output(
        self, name: str, description: str
    ) -> Self:
        """Declare a desired IntrospectionDirectiveArg output to be assigned in
        the environment
        ...
        _ctx = self._select("withIntrospectionDirectiveArgOutput", _args)
        return Env(_ctx)

    def with_introspection_directive_input(
        self,
        name: str,
        value: "IntrospectionDirective",
        description: str,
    ) -> Self:
        """Create or update a binding of type IntrospectionDirective in the
        environment
        ...
        name:
            The name of the binding
        value:
            The IntrospectionDirective value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withIntrospectionDirectiveInput", _args)
        return Env(_ctx)

    def with_introspection_directive_output(self, name: str, description: str) -> Self:
        """Declare a desired IntrospectionDirective output to be assigned in the
        environment
        ...
        _ctx = self._select("withIntrospectionDirectiveOutput", _args)
        return Env(_ctx)

    def with_introspection_enum_value_input(
        self,
        name: str,
        value: "IntrospectionEnumValue",
        description: str,
    ) -> Self:
        """Create or update a binding of type IntrospectionEnumValue in the
        environment
        ...
        name:
            The name of the binding
        value:
            The IntrospectionEnumValue value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withIntrospectionEnumValueInput", _args)
        return Env(_ctx)

    def with_introspection_enum_value_output(self, name: str, description: str) -> Self:
        """Declare a desired IntrospectionEnumValue output to be assigned in the
        environment
        ...
        _ctx = self._select("withIntrospectionEnumValueOutput", _args)
        return Env(_ctx)

    def with_introspection_field_input(
        self,
        name: str,
        value: "IntrospectionField",
        description: str,
    ) -> Self:
        """Create or update a binding of type IntrospectionField in the
        environment
        ...
        name:
            The name of the binding
        value:
            The IntrospectionField value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withIntrospectionFieldInput", _args)
        return Env(_ctx)

    def with_introspection_field_output(self, name: str, description: str) -> Self:
        """Declare a desired IntrospectionField output to be assigned in the
        environment
        ...
        _ctx = self._select("withIntrospectionFieldOutput", _args)
        return Env(_ctx)

    def with_introspection_input_value_input(
        self,
        name: str,
        value: "IntrospectionInputValue",
        description: str,
    ) -> Self:
        """Create or update a binding of type IntrospectionInputValue in the
        environment
        ...
        name:
            The name of the binding
        value:
            The IntrospectionInputValue value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withIntrospectionInputValueInput", _args)
        return Env(_ctx)

    def with_introspection_input_value_output(
        self, name: str, description: str
    ) -> Self:
        """Declare a desired IntrospectionInputValue output to be assigned in the
        environment
        ...
        _ctx = self._select("withIntrospectionInputValueOutput", _args)
        return Env(_ctx)

    def with_introspection_type_input(
        self,
        name: str,
        value: "IntrospectionType",
        description: str,
    ) -> Self:
        """Create or update a binding of type IntrospectionType in the
        environment
        ...
        name:
            The name of the binding
        value:
            The IntrospectionType value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withIntrospectionTypeInput", _args)
        return Env(_ctx)

    def with_introspection_type_output(self, name: str, description: str) -> Self:
        """Declare a desired IntrospectionType output to be assigned in the
        environment
        ...
        _ctx = self._select("withIntrospectionTypeOutput", _args)
        return Env(_ctx)

    def with_introspection_type_ref_input(
        self,
        name: str,
        value: "IntrospectionTypeRef",
        description: str,
    ) -> Self:
        """Create or update a binding of type IntrospectionTypeRef in the
        environment
        ...
        name:
            The name of the binding
        value:
            The IntrospectionTypeRef value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withIntrospectionTypeRefInput", _args)
        return Env(_ctx)

    def with_introspection_type_ref_output(self, name: str, description: str) -> Self:
        """Declare a desired IntrospectionTypeRef output to be assigned in the
        environment
        ...
        _ctx = self._select("withIntrospectionTypeRefOutput", _args)
        return Env(_ctx)
...
@typecheck
class IntrospectionDirective(Type):
    """A directive applied to a GraphQL introspection element."""

    async def args(self) -> list["IntrospectionDirectiveArg"]:
        """The arguments of the applied directive."""
        _args: list[Arg] = []
        _ctx = self._select("args", _args)
        return await _ctx.execute_object_list(IntrospectionDirectiveArg)

    async def id(self) -> IntrospectionDirectiveID:
        ...
        Returns
        -------
        IntrospectionDirectiveID
            The `IntrospectionDirectiveID` scalar type represents an
            identifier for an object of type IntrospectionDirective.
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(IntrospectionDirectiveID)
...
@typecheck
class IntrospectionDirectiveArg(Type):
    """An argument of an applied GraphQL introspection directive."""

    async def id(self) -> IntrospectionDirectiveArgID:
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(IntrospectionDirectiveArgID)
...
@typecheck
class IntrospectionEnumValue(Type):
    """A possible value of a GraphQL introspection enum type."""

    async def deprecation_reason(self) -> str | None:
        ...
        """
        _args: list[Arg] = []
        _ctx = self._select("deprecationReason", _args)
        return await _ctx.execute(str | None)
    ...
    async def directives(self) -> list[IntrospectionDirective]:
        """The directives applied to the enum value."""
        _args: list[Arg] = []
        _ctx = self._select("directives", _args)
        return await _ctx.execute_object_list(IntrospectionDirective)

    async def id(self) -> IntrospectionEnumValueID:
        ...
        Returns
        -------
        IntrospectionEnumValueID
            The `IntrospectionEnumValueID` scalar type represents an
            identifier for an object of type IntrospectionEnumValue.
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(IntrospectionEnumValueID)

    async def is_deprecated(self) -> bool:
        ...
        """
        _args: list[Arg] = []
        _ctx = self._select("isDeprecated", _args)
        return await _ctx.execute(bool)
...
@typecheck
class IntrospectionField(Type):
    """A field of a GraphQL introspection object or interface type."""

    async def args(self) -> list["IntrospectionInputValue"]:
        """The arguments accepted by the field."""
        _args: list[Arg] = []
        _ctx = self._select("args", _args)
        return await _ctx.execute_object_list(IntrospectionInputValue)
    ...
    async def id(self) -> IntrospectionFieldID:
        ...
        Returns
        -------
        IntrospectionFieldID
            The `IntrospectionFieldID` scalar type represents an identifier
            for an object of type IntrospectionField.
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(IntrospectionFieldID)
    ...
    def type_(self) -> "IntrospectionTypeRef":
        """The type of the field."""
        _args: list[Arg] = []
...
@typecheck
class IntrospectionInputValue(Type):
    """A GraphQL introspection input field or argument."""

    async def default_value(self) -> str | None:
    ...
    async def id(self) -> IntrospectionInputValueID:
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(IntrospectionInputValueID)
...
class IntrospectionType(Type):
    ...
    async def directives(self) -> list[IntrospectionDirective]:
        """The directives applied to the type, including @sourceModuleName for
    ...
    async def enum_values(self) -> list[IntrospectionEnumValue]:
        """The possible values of the type. Null unless the type is an enum."""
        _args: list[Arg] = []
        _ctx = self._select("enumValues", _args)
        return await _ctx.execute_object_list(IntrospectionEnumValue)

    async def fields(self) -> list[IntrospectionField]:
        """The fields of the type. Null unless the type is an object or
        interface.
        """
        _args: list[Arg] = []
        _ctx = self._select("fields", _args)
        return await _ctx.execute_object_list(IntrospectionField)

    async def id(self) -> IntrospectionTypeID:
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(IntrospectionTypeID)

    async def input_fields(self) -> list[IntrospectionInputValue]:
        """The input fields of the type. Null unless the type is an input object."""
        _args: list[Arg] = []
        _ctx = self._select("inputFields", _args)
        return await _ctx.execute_object_list(IntrospectionInputValue)

    async def interfaces(self) -> list["IntrospectionType"]:
        """The interfaces implemented by the type. Null unless the type is an
        object or interface.
        """
        _args: list[Arg] = []
        _ctx = self._select("interfaces", _args)
        return await _ctx.execute_object_list(IntrospectionType)
...
@typecheck
class IntrospectionTypeRef(Type):
    """A reference to a GraphQL introspection type."""

    async def id(self) -> IntrospectionTypeRefID:
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(IntrospectionTypeRefID)
    ...
    def of_type(self) -> Self:
        """The type wrapped by a list or non-null reference. Null for named
        types.
        """
        _args: list[Arg] = []
        _ctx = self._select("ofType", _args)
        return IntrospectionTypeRef(_ctx)
...
class Query(Root):
    ...
    def load_introspection_directive_arg_from_id(
        self, id: IntrospectionDirectiveArgID
    ) -> IntrospectionDirectiveArg:
        """Load a IntrospectionDirectiveArg from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadIntrospectionDirectiveArgFromID", _args)
        return IntrospectionDirectiveArg(_ctx)

    def load_introspection_directive_from_id(
        self, id: IntrospectionDirectiveID
    ) -> IntrospectionDirective:
        """Load a IntrospectionDirective from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadIntrospectionDirectiveFromID", _args)
        return IntrospectionDirective(_ctx)

    def load_introspection_enum_value_from_id(
        self, id: IntrospectionEnumValueID
    ) -> IntrospectionEnumValue:
        """Load a IntrospectionEnumValue from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadIntrospectionEnumValueFromID", _args)
        return IntrospectionEnumValue(_ctx)

    def load_introspection_field_from_id(
        self, id: IntrospectionFieldID
    ) -> IntrospectionField:
        """Load a IntrospectionField from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadIntrospectionFieldFromID", _args)
        return IntrospectionField(_ctx)

    def load_introspection_input_value_from_id(
        self, id: IntrospectionInputValueID
    ) -> IntrospectionInputValue:
        """Load a IntrospectionInputValue from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadIntrospectionInputValueFromID", _args)
        return IntrospectionInputValue(_ctx)

    def load_introspection_type_from_id(
        self, id: IntrospectionTypeID
    ) -> IntrospectionType:
        """Load a IntrospectionType from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadIntrospectionTypeFromID", _args)
        return IntrospectionType(_ctx)

    def load_introspection_type_ref_from_id(
        self, id: IntrospectionTypeRefID
    ) -> IntrospectionTypeRef:
        """Load a IntrospectionTypeRef from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadIntrospectionTypeRefFromID", _args)
        return IntrospectionTypeRef(_ctx)
    ...
    def load_schema_from_id(self, id: SchemaID) -> "Schema":
        """Load a Schema from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadSchemaFromID", _args)
        return Schema(_ctx)
...
class Schema(Type):
    ...
    def describe_type(self, name: str) -> IntrospectionType:
        """Return the full introspection details of a named type, or null if the
        ...
        _ctx = self._select("describeType", _args)
        return IntrospectionType(_ctx)

    async def has_type(self, name: str) -> bool:
        ...
        _ctx = self._select("hasType", _args)
        return await _ctx.execute(bool)

    async def id(self) -> SchemaID:
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(SchemaID)

    async def list_types(self, *, kind: str | None = "") -> list[str]:
        """List the names of the types defined in the schema.

        Parameters
        ----------
        kind:
            Only list types of this kind, e.g. "OBJECT", "INTERFACE", "ENUM",
            "SCALAR" or "INPUT_OBJECT". Lists every type if omitted.
        ...
        _ctx = self._select("listTypes", _args)
        return await _ctx.execute(list[str])
...
class WorkspaceModuleSetting(Type):
    ...
    async def id(self) -> WorkspaceModuleSettingID:
        ...
        WorkspaceModuleSettingID
            The `WorkspaceModuleSettingID` scalar type represents an
            identifier for an object of type WorkspaceModuleSetting.
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(WorkspaceModuleSettingID)
