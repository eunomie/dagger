...
func pascalCase(name string) string {
	// in strcase, ToCamel is PascalCase and real camel case is ToLowerCamel
...
func isKeyword(s string) bool {
	_, isKeyword := rubyKeywords[strings.ToLower(s)]
...
// formatEnum formats a GraphQL enum into a Ruby equivalent
